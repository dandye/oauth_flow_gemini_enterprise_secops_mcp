...
- `src/oauth_flow_gemini_enterprise_secops_mcp/`: Core configuration utilities, unified management CLI (`cli.py`), and `installation_scripts/` subcommands for Vertex AI Agent Engine, Gemini Enterprise (AgentSpace), OAuth authorizations, and IAM.
